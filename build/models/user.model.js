...
var hashPassword = function (pass) {
    ...
    return bcrypt_1.default.hashSync("".concat(pass).concat(config_1.default.pepper), salt);
};
var UserModel = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        error_1 = _a.sent();
                        throw new Error("Unable to create user (".concat(user.first_name, "): ").concat(error_1.message));
                    case 5:
    ...
    UserModel.prototype.authenticate = function (email, password) {
        return __awaiter(this, void 0, void 0, function () {
            var connection, sql, result, hashPassword_1, isPasswordValid, sql_1, userInfo, err_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        connection = undefined;
                    ...
                    case 3:
                        ...
                        sql_1 = 'SELECT id, email, first_name, last_name FROM users WHERE email=($1)';
