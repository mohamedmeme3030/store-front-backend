...
exports.deleteProduct = exports.getProduct = exports.index = exports.update = exports.create = void 0;
...
var index = function (_req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var indexResult, err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, productModel.indexProduct()];
            case 1:
                indexResult = _a.sent();
                res.json({
                    status: 'success',
